...
// Creates and inserts the Event Tickets RSVP block. It is also supposed to configure and instantiate the block, but this feature works, ostensibly, only with Event Tickets Plus, which costs nearly $200/year. The error being returned is a 401, suggesting failed authorization (for the Event Tickets API). The block does appear on the page in the WP editor, though it is not configured, as it shoul be.
